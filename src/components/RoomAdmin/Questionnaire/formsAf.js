...

              {
                sent ?
                  <>
                    ...
                    {aspartame !== "" ? `Aspartame: ${aspartame}` : null}
              ...
              <div style={{ display: sample !== '' ? "block" : "none" }}>
                ...
                />
                {
                  sample ?
                    <DefeitosGerais
                      sample={sample}
                      set={[setAspartame, setCloro, setAmargor, setOxidacao, setQueimado, setPlastico, setMedicinal, setTerra, setMetalico, setAzedo, setAcetico, setQuimico, setMelaco, setAcucarNaoTratado, setAdstringente]}
                      values={[aspartame, cloro, amargor, oxidacao, queimado, plastico, medicinal, terra, metalico, azedo, acetico, quimico, melaco, acucarNaoTratado, adstringente]}
                    /> : null
                }
